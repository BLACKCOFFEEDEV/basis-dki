...
class CI_Googlemaps {
	...
	var $apiKey						= 'AIzaSyApHNWWzhT1JLH4rmcYR9SCjl1LO_yoMm0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center						= "-6.181908, 106.828249";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
	...
	var $drawingDefaultMode			= 'null';					// The default mode for the Drawing Manager. Accepted values are marker, polygon, polyline, rectangle, circle, or null. null means that the user can interact with the map as normal when the map loads, and clicks do not draw anything.
