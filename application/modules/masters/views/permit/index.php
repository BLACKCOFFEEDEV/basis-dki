...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Business Permit
            <small>list of business permit</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Master Data</a></li>
            <li class="active">List of business permit</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <a href="<?php echo base_url('masters/permit/form') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Create new business permit</a><br/><br/>
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Business Permit</h3>
                    </div>
...
<script type="text/javascript">
    ...
    function DrawTable() {
        $('#datatables').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('masters/permit/get_list/')?>",
                "type": "POST"
            },
    ...
    function confirmation() {
        $.ajax({
            url : "<?php echo base_url('masters/permit/delete') ?>",
            method : "post",
            data : {
                id : $("#key").val()
            },
