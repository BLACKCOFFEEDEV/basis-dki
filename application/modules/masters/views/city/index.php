...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">List of city</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <a href="<?php echo base_url('masters/city/form') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Create new city</a><br/><br/>
                <div class="box">
...
<script type="text/javascript">
    ...
    function DrawTable() {
        $('#datatables').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('masters/city/get_list/')?>",
                "type": "POST"
            },
    ...
    function confirmation() {
        $.ajax({
            url : "<?php echo base_url('masters/city/delete') ?>",
            method : "post",
            data : {
                id : $("#key").val()
            },
