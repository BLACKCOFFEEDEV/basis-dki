...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            State
            <small>list of state</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Master Data</a></li>
            <li class="active">List of state</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <a href="<?php echo base_url('masters/state/form') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Create new state</a><br/><br/>
                <div class="box">
...
<script type="text/javascript">
    ...
    function DrawTable() {
        $('#datatables').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('masters/state/get_list/')?>",
                "type": "POST"
            },
    ...
    function confirmation() {
        $.ajax({
            url : "<?php echo base_url('masters/state/delete') ?>",
            method : "post",
            data : {
                id : $("#key").val()
            },
