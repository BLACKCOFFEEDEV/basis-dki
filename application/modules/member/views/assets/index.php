...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Assets Member
            <small>list of Assets</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Member Data</a></li>
            <li class="active">List of Assets Member</li>
        </ol>
    </section>
...
<script type="text/javascript">
    ...
    function DrawTable() {
        $('#datatables').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('member/assets/get_list/')?>",
                "type": "POST"
            },
    ...
    function confirmation() {
        $.ajax({
            url : "<?php echo base_url('member/assets/delete') ?>",
            method : "post",
            data : {
                id : $("#key").val()
            },
