...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Navigation
            <small>list of navigation</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li><a href="#">Navigation</a></li>
            <li class="active">List of navigation</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-xs-12">
                <a href="<?php echo base_url('privileges/menu/form') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Create new navigation</a><br/><br/>
                <div class="box">
...
<script type="text/javascript">
    ...
    function DrawTable() {
        $('#datatables').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?php echo site_url('privileges/menu/get_list/')?>",
                "type": "POST"
            },
    ...
    function confirmation() {
        $.ajax({
            url : "<?php echo base_url('privileges/menu/delete') ?>",
            method : "post",
            data : {
                id : $("#key").val()
            },
